...
public class PathMarker extends AbstractItem {
	private static Image image1, image2;

	public PathMarker(Owner parent) {
		super(parent);
	}
	...
	public void init() {
		...
		try {
			image1 = new Image("gfx/items/pathmarker.png", Color.magenta);
			image2 = new Image("gfx/items/pathmarker2.png", Color.magenta);
