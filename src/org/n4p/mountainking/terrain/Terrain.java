...
public class Terrain {
	...
	public ArrayList<AbstractItem> getItemsAt(Coord c) {
	...
	public static class TerrainNode implements Owner {
		...
		private ArrayList<AbstractItem> mItems = null;
		...
		public void initItems() {
			if(mItems != null)
				...
				mItems = new ArrayList<AbstractItem>();
		}
		...
		public boolean equals(Object aThat) {
			...
			// Equivalent iff...
			return (this.mVisible == that.mVisible && // Both visible or both hidden
																								// or both undefined
					this.mType.getID() == that.mType.getID() && // Both same type
					(this.mItems == null || this.mItems.isEmpty()) && // This has no
																														// Items
			(that.mItems == null || that.mItems.isEmpty())); // That has no
																												// Items
		}
